#!/usr/bin/env python3
"""
Coding Brain MCP Server
Your intelligent coding assistant combining session history with elite GitHub patterns and best practices
"""
...
# Add archived coding history modules to path
...
mcp = FastMCP(
    "Coding Brain",
    instructions="""
Your intelligent coding assistant that combines:
- Your coding session history and terminal output
- Elite coding patterns from top GitHub repositories
- Best practices and coding rules from industry leaders
- Reusable methods and functions from trusted sources

Capabilities:
- Terminal output capture and storage
- Advanced search across your history and GitHub patterns
- Pattern recognition for errors with solutions from top repos
- Session management and progress tracking
- Query best practices from elite repositories by language/framework

Use search_history() for your sessions, search_github_patterns() for elite code examples,
and get_best_practices() to learn from top repositories.
    """
)
...
def get_recent_history() -> str:
    """Get recent coding brain activity summary"""
    results = db.search_chunks(limit=50)

    if not results:
        return "No recent coding brain activity found"

    lines = ["🧠 CODING BRAIN - RECENT ACTIVITY", "=" * 50, ""]
