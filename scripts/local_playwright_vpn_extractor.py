#!/usr/bin/env python3
"""
Local Playwright extractor using your VPN connection
Scrapes YouTube directly, routing through ProtonVPN
"""
...
def main():
    ...
    print("="*70)
    print("\n⚠️  IMPORTANT: Make sure ProtonVPN is CONNECTED!")
    print("   This will use Playwright locally with your VPN connection.\n")
    ...
    # Ask for workers
    try:
        workers = int(input("\nHow many parallel workers? (recommended: 3-5 to avoid rate limits): "))
    except:
        workers = 3

    if workers > 5:
        print("⚠️  Warning: Too many workers may trigger rate limits. Capping at 5.")
        workers = 5

    print(f"\n🚀 Starting extraction with {workers} workers...")
    print("   Each browser will route through your ProtonVPN")
    print("="*70 + "\n")
