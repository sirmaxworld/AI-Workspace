#!/usr/bin/env python3
"""
AI Insights Enricher - Claude Sonnet 4 Version
Uses Anthropic Claude Sonnet 4 for high-quality insights generation
Optimized for parallel processing with high throughput
"""
...
class AIInsightsEnricherClaude:
    """Enriches YC companies with AI-generated insights using Claude Sonnet 4"""
...
def main():
    ...
    if enriched_file.exists():
        ...
        print(f"\n{'='*70}")
        print(f"AI Insights (Claude) for: {company['name']}")
        print(f"{'='*70}")
